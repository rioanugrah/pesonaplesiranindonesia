    ...
    <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
        ...
        <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
            <li
                ...
                <a href="{{ route('admin.home') }}" class="text-slate-400 dark:text-zink-200">Dashboards</a>
            </li>
    ...
    <div class="grid grid-cols-12 2xl:grid-cols-12 gap-x-5">
        <div class="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
            <div class="text-center card-body">
                ...
                <h5 class="mt-4 mb-2"><span class="counter-value" data-target="0">0</span></h5>
        ...
        <div class="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
            <div class="text-center card-body">
                ...
                <h5 class="mt-4 mb-2"><span class="counter-value" data-target="0">0</span></h5>
                <p class="text-slate-500 dark:text-zink-200">Total Invoice</p>
            </div>
        </div>
        <div class="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
            <div class="text-center card-body">
                ...
                <p class="text-slate-500 dark:text-zink-200">Total Cancelled</p>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="grid items-center grid-cols-1 gap-3 mb-5 2xl:grid-cols-12">
                    <div class="2xl:col-span-3">
                        <h6 class="text-15">Booking Order</h6>
                    </div><!--end col-->
