...
class TestingController extends Controller
{
    ...
    public function uploadImageWatermark(Request $request)
    {
        $watermark =  \Image::make(public_path('logo/logoppiwhite.png'));
        $img = \Image::make(public_path('18314.jpg'));
        //#1
        ...
        //save new image
        $img->save(public_path(Carbon::now()->format('Ymd').'.png'));

        dd('image successfully.');
    }
}
